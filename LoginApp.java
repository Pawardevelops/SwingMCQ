...
public class LoginApp extends JFrame implements ActionListener {
    ...
    private void handleForgotPassword() {
        ...
        if (user != null) {
            ...
            forgotPasswordApp = new ForgotPasswordApp(users,username);
        } else {
            ...
            try {
                ...
                if (loginSuccess) {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        OnlineTest testApp = new OnlineTest(username);
    ...
    private class RegistrationWindow extends JFrame implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == registerUserButton) {
                ...
                if (username.isEmpty() || password.length == 0 || securityQuestion.isEmpty() || securityAnswer.isEmpty()) {
                    // users are not allowed to enter empty fileds or else they have to reEnter all fileds
